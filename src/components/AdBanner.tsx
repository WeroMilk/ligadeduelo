...
export default function AdBanner() {
  ...
  return (
    ...
    >
      <div
        className="relative mx-auto w-full max-w-lg overflow-hidden rounded-lg border border-[#2A3550]/80 bg-[#0E121C] shadow-[0_4px_18px_rgba(0,0,0,0.35)]"
        style={{ userSelect: 'none' }}
      >
        <span className="absolute right-2 top-1.5 z-10 rounded bg-black/55 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-[0.16em] text-white/90">
          Publicidad
        </span>
