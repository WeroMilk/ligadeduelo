...
export default function AdBanner() {
  ...
  return (
    ...
    >
      <div
        className="relative mx-auto w-full max-w-[728px] overflow-hidden rounded-sm bg-[#111827]"
      ...
      >
        ...
        <img
          ...
          className="block h-[25px] w-full object-cover object-center sm:h-[30px] md:h-[45px]"
          loading="lazy"
          decoding="async"
          draggable={false}
        />
