...
export const CHAMPIONS: ChampionDef[] = [
  {
    id: 'darius', name: 'Darius', role: 'top', image: '/champions/darius.svg', color: '#8B0000', initials: 'DA',
  ...
  {
    id: 'garen', name: 'Garen', role: 'top', image: '/champions/garen.svg', color: '#2E5C3F', initials: 'GA',
  ...
  {
    id: 'malphite', name: 'Malphite', role: 'top', image: '/champions/malphite.svg', color: '#5B6B7F', initials: 'MA',
  ...
  {
    id: 'shen', name: 'Shen', role: 'top', image: '/champions/shen.svg', color: '#2A4D7A', initials: 'SH',
  ...
  {
    id: 'aatrox', name: 'Aatrox', role: 'top', image: '/champions/aatrox.svg', color: '#6B1A1A', initials: 'AA',
  ...
  {
    id: 'sett', name: 'Sett', role: 'top', image: '/champions/sett.svg', color: '#C45C26', initials: 'ST',
  ...
  {
    id: 'lee_sin', name: 'Lee Sin', role: 'jungle', image: '/champions/lee_sin.svg', color: '#1B7A3D', initials: 'LS',
  ...
  {
    id: 'amumu', name: 'Amumu', role: 'jungle', image: '/champions/amumu.svg', color: '#4A6741', initials: 'AM',
  ...
  {
    id: 'kayn', name: 'Kayn', role: 'jungle', image: '/champions/kayn.svg', color: '#6B1FA6', initials: 'KA',
  ...
  {
    id: 'vi', name: 'Vi', role: 'jungle', image: '/champions/vi.svg', color: '#C44BC4', initials: 'VI',
  ...
  {
    id: 'graves', name: 'Graves', role: 'jungle', image: '/champions/graves.svg', color: '#8B5A2B', initials: 'GR',
  ...
  {
    id: 'sejuani', name: 'Sejuani', role: 'jungle', image: '/champions/sejuani.svg', color: '#4A90A4', initials: 'SJ',
  ...
  {
    id: 'ahri', name: 'Ahri', role: 'mid', image: '/champions/ahri.svg', color: '#9B59B6', initials: 'AH',
  ...
  {
    id: 'lux', name: 'Lux', role: 'mid', image: '/champions/lux.svg', color: '#F1C40F', initials: 'LU',
  ...
  {
    id: 'zed', name: 'Zed', role: 'mid', image: '/champions/zed.svg', color: '#2C3E50', initials: 'ZE',
  ...
  {
    id: 'yasuo', name: 'Yasuo', role: 'mid', image: '/champions/yasuo.svg', color: '#7F8C8D', initials: 'YA',
  ...
  {
    id: 'syndra', name: 'Syndra', role: 'mid', image: '/champions/syndra.svg', color: '#5E2B8A', initials: 'SY',
  ...
  {
    id: 'orianna', name: 'Orianna', role: 'mid', image: '/champions/orianna.svg', color: '#4FC3F7', initials: 'OR',
  ...
  {
    id: 'caitlyn', name: 'Caitlyn', role: 'adc', image: '/champions/caitlyn.svg', color: '#2980B9', initials: 'CA',
  ...
  {
    id: 'jinx', name: 'Jinx', role: 'adc', image: '/champions/jinx.svg', color: '#E91E63', initials: 'JI',
  ...
  {
    id: 'ezreal', name: 'Ezreal', role: 'adc', image: '/champions/ezreal.svg', color: '#00BCD4', initials: 'EZ',
  ...
  {
    id: 'kaisa', name: "Kai'Sa", role: 'adc', image: '/champions/kaisa.svg', color: '#673AB7', initials: 'KS',
  ...
  {
    id: 'ashe', name: 'Ashe', role: 'adc', image: '/champions/ashe.svg', color: '#5DADE2', initials: 'AS',
  ...
  {
    id: 'jhin', name: 'Jhin', role: 'adc', image: '/champions/jhin.svg', color: '#A93226', initials: 'JH',
  ...
  {
    id: 'leona', name: 'Leona', role: 'support', image: '/champions/leona.svg', color: '#FF9800', initials: 'LE',
  ...
  {
    id: 'thresh', name: 'Thresh', role: 'support', image: '/champions/thresh.svg', color: '#1A6B3E', initials: 'TH',
  ...
  {
    id: 'lulu', name: 'Lulu', role: 'support', image: '/champions/lulu.svg', color: '#E040FB', initials: 'LL',
  ...
  {
    id: 'soraka', name: 'Soraka', role: 'support', image: '/champions/soraka.svg', color: '#00E676', initials: 'SO',
  ...
  {
    id: 'nautilus', name: 'Nautilus', role: 'support', image: '/champions/nautilus.svg', color: '#1A5276', initials: 'NA',
  ...
  {
    id: 'yuumi', name: 'Yuumi', role: 'support', image: '/champions/yuumi.svg', color: '#F48FB1', initials: 'YU',
